...
sscurves_Dengue6
ROC_Dengue6 <- autoplot(sscurves_Dengue6, curvetype = c("ROC")) + labs(title = "ROC curve of the complicated malaria signature in GSE13052 (Dengue fever)") + annotate("text", x = .65, y = .25, label = paste("AUC = 0.64"), size = 5)
PRC_Dengue6 <- autoplot(sscurves_Dengue6, curvetype = c("PRC")) + labs(title = "PRC curve of the complicated malaria signature in GSE13052 (Dengue fever)") + annotate("text", x = .65, y = .25, label = paste("AUPRC = 0.566"), size = 5)
