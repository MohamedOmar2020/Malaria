...
## Load the data
load("./Objs/MalariaDataGood_GSE117613Out.rda")
...
ImportantGns_GSE117613Out <- rownames(rf_importances)[1:50]
save(ImportantGns_GSE117613Out, file = "./Objs/ImportantGns_GSE117613Out.rda")
...
png("./Figs/RF_varImp_GSE117613Out.png", width = 2000, height = 2000, res = 300)
...
png("./Figs/MDS_GSE117613Out.png", width = 2000, height = 2000, res = 300)
...
png(filename = "./Figs/MultiROC_TestingData_GSE117613Out.png", width = 2000, height = 2000, res = 300)
...
png(filename = "./Figs/MultiPRC_TestingData_GSE117613Out.png", width = 2000, height = 2000, res = 300)
