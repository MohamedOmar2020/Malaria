...
# Plot
png(filename = "./Figs/SevereKTSP_Heatmap.png", width = 3000, height = 2000, res = 200)
superheat(Complicated_Stats, col.dendrogram = F, yr = rowSums(Complicated_Stats), yr.plot.type  = "bar", left.label.text.col = c("blue", "red"), membership.rows = CompGroup, bottom.label.text.size = 3.5, yr.num.ticks = 6, yr.axis.name	= "Sum of votes", yr.obs.col = PredClass, title = "Heatmap for the TSPs votes in the testing data")
dev.off()
